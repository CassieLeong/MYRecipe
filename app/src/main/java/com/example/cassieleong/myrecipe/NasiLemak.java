...
public class NasiLemak extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        setContentView(R.layout.content_nasi_lemak);

        YouTubePlayerView youTubePlayerView = (YouTubePlayerView)

                findViewById(R.id.youtube_view6);
    ...
    protected YouTubePlayer.Provider getYouTubePlayerProvider() {
        return (YouTubePlayerView) findViewById(R.id.youtube_view6);
    }
