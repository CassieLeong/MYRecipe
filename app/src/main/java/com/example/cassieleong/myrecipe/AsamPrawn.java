...
public class AsamPrawn extends YouTubeBaseActivity implements
    ...
    private String VIDEO_ID = "S7mAUUU8_vo"; // youtube URL after v=

    @Override
    protected void onCreate(Bundle saveInstanceState) {
        //TODO Auto-generated method stub
        super.onCreate(saveInstanceState);
        setContentView(R.layout.content_asam_prawn);

        YouTubePlayerView youTubePlayerView = (YouTubePlayerView)

                findViewById(R.id.youtube_view3);
    ...
    protected YouTubePlayer.Provider getYouTubePlayerProvider() {
        return (YouTubePlayerView) findViewById(R.id.youtube_view3);
    }
