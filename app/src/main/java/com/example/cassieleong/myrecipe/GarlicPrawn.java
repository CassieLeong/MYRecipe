...
public class GarlicPrawn extends YouTubeBaseActivity implements
    ...
    private String VIDEO_ID = "y2ASZpEuA_g"; // youtube URL after v=

    @Override
    protected void onCreate(Bundle saveInstanceState) {
        //TODO Auto-generated method stub
        super.onCreate(saveInstanceState);
        setContentView(R.layout.content_garlic_prawn);

        YouTubePlayerView youTubePlayerView = (YouTubePlayerView)

                findViewById(R.id.youtube_view5);
    ...
    protected YouTubePlayer.Provider getYouTubePlayerProvider() {
        return (YouTubePlayerView) findViewById(R.id.youtube_view5);
    }
